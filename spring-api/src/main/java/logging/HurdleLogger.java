...
public class HurdleLogger {
	...
	private static final Logger staticLogger = LogManager.getLogger(HurdleLogger.class);
	...
	public static void error(String message, Throwable throwable) {
		staticLogger.error(message, throwable);
	}
	
	public static void fatal(String message) {
		staticLogger.fatal(message);
	}
	
	public static void fatal(String message, Throwable throwable) {
		staticLogger.fatal(message, throwable);
	}
